	...
	<body onload="init()">
		...
		<div id="wrapper">
			...
			<div id="content"> <!-- Menyn är statisk och beror på vilken typ av sida det är allt annat kommer hämtas ur DB mha id på den öppnade sidan som skickas mellan sidorna  -->
				<div class="contentRutor vänster"><a href="skapaSida.php?valdSida=trad&id=<?php echo $id; ?>">Skapa Ny Tråd</a></div>
				<div class="contentRutor mitten">Öppnad Sida:<a href="index.php"><?php echo $namnOpenSida['namn']; ?></a></div>
				<div class="contentRutor höger">Välj Sida: 1 2 3 4 > Sista</div>
				<div class="overskrifter rutorStora">Tråd</div>
				<div class="overskrifter rutorSmå">Datum skapad</div>
				<div class="overskrifter rutorSmå">Antal Inlägg</div>
